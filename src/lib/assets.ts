export type TemplateId = "signature" | "toystory1" | "toystory2" | "toystory3" | "toystory4" | "toystory5" | "sprinkle" | "minimal" | "soccer";
...
export const TEMPLATES: TemplateConfig[] = [
  ...
  {
    id: "toystory5",
    name: "Toy Story Frame 5",
    description: "",
    frameSrc: "/frames/연습.png",
    background: "#4A90C4",
    frameOverlay: true,
  },
  {
